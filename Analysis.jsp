...
<title>Analysis Date Wise</title>
    <style>
        body
        {
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Analysis Date Wise</a></li>        
      </ul>
...
<div class="row">
                ...
                <div class="panel panel-info">
                        <div class="panel-heading" style="background-color:aqua">
                            <div class="row">
                                <div class="col-xs-3">
                                   <span style="font-size: 30px; color:navy" class="glyphicon glyphicon-search"></span>
                                </div>
                                <div class="col-xs-12">                                    
                                    <div><h3 style="color: white;text-align: left">ANALYSIS DATA WISE</h3></div>
                                </div>
                            </div>
                        </div>
