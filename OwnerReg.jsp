...
<style>
body {    
    background-image: url("images1/owner.jpg");
...
<body>
	...
	<div class="main">
		<div class="main-w3l">
			<h1 class="logo-w3">Owner Register Form</h1>
			<div class="w3layouts-main">
				<h2><span>Register now</span></h2>
					<form action="OwnerReg" method="post">
						<input placeholder="Shop Name" name="shopname" type="text" required="">
						<input placeholder="Branch" name="branch" type="text" required="">
						<input placeholder="Area" name="area" type="text" required="">
						...
						<input placeholder="confirmPassword" name="confirmpassword" type="password"  id="password2" required="">
						<input type="submit" value="new Register" name="login">
						<br>
						<br>
